      ...
      return (
        <nav className="flex items-center justify-between p-8 border-b-2 h-16">
          ...
          <div className="relative">
            {/* Toggle button */}
            <button
              className="font-inter text-2xl font-semibold leading-22 text-black px-4"
              onClick={toggleMenu}
            >
              <IoMenu />
            </button>
                ...
                <div className="bg-white w-72 p-2 rounded-l-md ">
                  <ul className="flex flex-col space-y-2 pl-2">
                    <div className="flex justify-between items-center mt-2 mb-3">
                      ...
                      <button
                        className="font-inter text-base font-semibold leading-22 text-black bg-gray-200 px-3 py-1 mr-8 rounded-lg"
                        onClick={toggleMenu}
                      >
                        ✕
                      </button>
